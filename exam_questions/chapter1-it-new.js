const questions = [
    ...
    [
        {
            // 56
            question: "Anchors can be placed to _______",
            optionA: "Character",
            optionB: "Paragraph",
            optionC: "Frame",
            optionD: "All of the above",
        ...
        {
            question: "एंकर्स ______ के लिए लगाये जा सकते हैं।",
            optionA: "वर्ण",
            optionB: "पैराग्राफ",
            optionC: "फ्रेम",
            optionD: "उपरोक्त सभी",
    ...
    [
        {
            // 65
            question: "Shortcut key for Save As is _______ in Writer",
            optionA: "Ctrl + S",
        ...
        {
            question: "राइटर में सेव ऐज के लिए शॉर्टकट कुंजी है ________",
            optionA: "Ctrl + S",
            optionB: "Ctrl + Shift + S",
            optionC: "Ctrl + Alt + S",
            optionD: "उपरोक्त में से कोई नहीं",
    ...
    [
        ...
        {
            question: "फुटनोट _________ पर रखा गया है।",
            optionA: "सभी पृष्ठों के नीचे लेकिन समान",
            optionB: "प्रत्येक पृष्ठ के नीचे लेकिन अलग",
            optionC: "पृष्ठ के फुटर के अंदर",
            optionD: "पेज के हेडर के अंदर",
            correctAnswer: "रत्येक पृष्ठ के नीचे लेकिन अलग"
        }
    ],
